...
const Hero = () => {
  ...
  return (
    <div className='relative w-screen overflow-x-hidden h-dvh'>
        ...
        {isLoading && (
            <div className='absolute z-[100] flex-center h-dvh overflow-hidden w-screen bg-violet-50'>
        ...
        <div id='video-frame' className='relative z-10 w-screen overflow-hidden rounded-lg h-dvh bg-blue-75'>
            ...
            <div className='absolute top-0 left-0 z-40 size-full'>
                <div className='px-5 mt-24 sm:px-10'>
                    ...
                    <p className='mb-5 text-blue-100 max-w-70 font-robert-regular'>
                        Khám phá thể giới Metagame Layer <br/>
